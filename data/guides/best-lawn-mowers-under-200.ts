...
export const buyingCriteria = [
  ...
  { criterion: "Excluding temporary sale-only qualification", explanation: "A mower that only fits under $200 during a limited-time sale is not a reliable pick for this tier. Confirm the regular list price so the purchase still makes sense if the sale ends.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers weeks after buying, since excluding temporary sale-only qualification plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of excluding temporary sale-only qualification, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers for a while." },
  ...
  { criterion: "Separating power sources at this tier", explanation: "Reel, corded electric, battery electric, and gas mowers behave very differently under $200. A reel mower has no ongoing power cost but limited grass handling, corded mowers need outlet access and cord management, battery mowers add charging time and a battery to eventually replace, and gas mowers need fuel and engine upkeep.\n\nSeparating power sources at this tier is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on separating power sources at this tier directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers options genuinely diverge." },
  { criterion: "Meaningful improvement at the next tier", explanation: "Moving into the $200 to $300 range typically buys wider decks, self-propel drive, larger included batteries, or gas engines with more displacement. Confirm the extra spend actually solves a problem your current yard has before paying more.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since meaningful improvement at the next tier affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on meaningful improvement at the next tier rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
export const howWeEvaluated = [
  { title: "Yard size and power source fit", description: "We matched deck width and power source, reel, corded, battery, or gas, against realistic yard sizes rather than assuming every mower under that suits every lawn." },
