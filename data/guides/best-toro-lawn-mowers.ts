...
export const buyingCriteria = [
  { criterion: "Verify the exact family", explanation: "Recycler, Super Recycler, TimeMaster, TimeCutter, TITAN, and Z Master are different platforms. Match the exact model number before comparing parts or price.\n\nGetting this wrong is one of the more common reasons a toro lawn mowers purchase disappoints once it actually arrives, since verify the exact family affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on verify the exact family rather than assuming every toro lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Tool-only battery pricing", explanation: "Both verified Amazon listings omit batteries and chargers. Add compatible pack capacity and charging equipment before comparing their real purchase cost.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a toro lawn mowers weeks after buying, since tool-only battery pricing plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of tool-only battery pricing, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the toro lawn mowers for a while." },
  { criterion: "21 vs 30 inches", explanation: "A 30-inch deck reduces passes on open grass but increases weight, turning space, and storage width. A 21-inch model is easier around beds and gates.\n\nBuyers who skip past 21 vs 30 inches tend to be the ones leaving disappointed reviews later, not because the toro lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each toro lawn mowers in this roundup actually handles 21 vs 30 inches rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Recycler is a claim", explanation: "Toro describes its clipping system, but real mulching quality changes with blade condition, grass height, moisture, and mowing speed and remains unmeasured here.\n\nRecycler is a claim is easy to overlook next to flashier specs, but it's frequently the difference between a toro lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on recycler is a claim directly from the current listing before ordering, since this is one of the more common places where two similarly priced toro lawn mowers options genuinely diverge." },
  { criterion: "Parts and service", explanation: "Check blade, belt, battery, and local service availability by exact SKU. Similar Toro family names do not guarantee compatible parts.\n\nGetting this wrong is one of the more common reasons a toro lawn mowers purchase disappoints once it actually arrives, since parts and service affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on parts and service rather than assuming every toro lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
