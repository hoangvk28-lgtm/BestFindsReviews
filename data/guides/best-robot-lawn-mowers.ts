...
export const buyingCriteria = [
  { criterion: "Navigation architecture", explanation: "RTK needs reliable sky visibility, LiDAR depends on stable physical features, vision depends on recognizable boundaries, and wire systems require installation but are less dependent on mapping.\n\nGetting this wrong is one of the more common reasons a lawn mowers robot purchase disappoints once it actually arrives, since navigation architecture affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on navigation architecture rather than assuming every lawn mowers robot in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Real mowable area", explanation: "Match the grass area, not the lot size. Divide the yard into zones and include corridors, tree cover, buildings, and slopes that complicate travel.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers robot weeks after buying, since real mowable area plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of real mowable area, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers robot for a while." },
  { criterion: "Boundary edge gap", explanation: "Measure the uncut strip at walls, raised curbs, beds, and fences. A built-in edge feature can reduce trimming but rarely eliminates it everywhere.\n\nBuyers who skip past boundary edge gap tend to be the ones leaving disappointed reviews later, not because the lawn mowers robot was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers robot in this roundup actually handles boundary edge gap rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Recovery behavior", explanation: "Ask what happens after blocked passages, wheel slip, lost signal, rain, or a moved obstacle. Reliable self-recovery matters more than a successful first map.\n\nRecovery behavior is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers robot that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on recovery behavior directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers robot options genuinely diverge." },
  { criterion: "Ongoing ownership", explanation: "Budget replacement razor blades, battery replacement, cleaning, winter storage, connectivity, and the manual trimming that remains.\n\nGetting this wrong is one of the more common reasons a lawn mowers robot purchase disappoints once it actually arrives, since ongoing ownership affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on ongoing ownership rather than assuming every lawn mowers robot in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
