...
export const products: GuideProduct[] = [
  {
    ...
    specList: [{"label":"Navigation","value":"Wire-free navigation for up to 1 acre"},{"label":"Durability","value":"4WD rated for 84% slopes"},{"label":"Feature 3","value":"Zero-turn steering"},{"label":"Size","value":"Dual 180W motors, 0.75 to 4 inch cutting height"}],
