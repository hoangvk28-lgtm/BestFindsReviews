...
export const buyingCriteria = [
  { criterion: "Watt-hours, not voltage", explanation: "Multiply nominal volts by amp-hours to compare approximate battery energy. Then confirm how many packs are included and whether the mower can use them simultaneously.\n\nGetting this wrong is one of the more common reasons a lawn mowers electric purchase disappoints once it actually arrives, since watt-hours, not voltage affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on watt-hours, not voltage rather than assuming every lawn mowers electric in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Grass load changes runtime", explanation: "Manufacturer runtime is not a guarantee in tall, damp, dense, or mulched grass. Plan capacity around the difficult parts of the lawn, not the easiest pass.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers electric weeks after buying, since grass load changes runtime plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of grass load changes runtime, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers electric for a while." },
  { criterion: "Self-propel energy", explanation: "Drive motors reduce pushing effort but share stored energy with the blade. Slopes and high drive speed can shorten mowing time.\n\nBuyers who skip past self-propel energy tend to be the ones leaving disappointed reviews later, not because the lawn mowers electric was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers electric in this roundup actually handles self-propel energy rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Charging workflow", explanation: "Compare full charge time, battery cooling delay, number of charger ports, and whether household wiring can support simultaneous fast charging.\n\nCharging workflow is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers electric that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on charging workflow directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers electric options genuinely diverge." },
  { criterion: "Corded constraints", explanation: "A corded mower avoids battery replacement but needs the correct outdoor extension cord and a mowing pattern that keeps the cable behind the machine.\n\nGetting this wrong is one of the more common reasons a lawn mowers electric purchase disappoints once it actually arrives, since corded constraints affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on corded constraints rather than assuming every lawn mowers electric in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
