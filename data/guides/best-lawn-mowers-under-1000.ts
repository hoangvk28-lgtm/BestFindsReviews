...
export const buyingCriteria = [
  { criterion: "Complete ready-to-mow price", explanation: "For battery mowers, confirm the listed price already includes at least one battery and a charger. A mower body sold separately can push the real ready-to-mow total well past the number on the page.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since complete ready-to-mow price affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on complete ready-to-mow price rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  ...
  { criterion: "Minimum cut, safety, and warranty standards", explanation: "Look for an adjustable cutting height range, a blade-stop or presence-control safety feature, and at least a standard residential warranty before comparing anything else.\n\nBuyers who skip past minimum cut, safety, and warranty standards tend to be the ones leaving disappointed reviews later, not because the lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers in this roundup actually handles minimum cut, safety, and warranty standards rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Separate reel, corded, battery, and gas at this tier", explanation: "Under $1000 these are four genuinely different ownership experiences, not just price points. A manual reel mower, a corded electric, a battery mower, and a small gas engine each carry different effort, maintenance, and range tradeoffs that matter more than the price gap between them.\n\nSeparate reel, corded, battery, and gas at this tier is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on separate reel, corded, battery, and gas at this tier directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers options genuinely diverge." },
  { criterion: "What a meaningful step up buys at the next tier", explanation: "Moving above $1000 typically buys a wider deck, a riding or zero-turn format, or commercial-grade components, rather than just a nicer version of the same walk-behind mower. Decide whether that step is actually necessary for your property before spending more.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since what a meaningful step up buys at the next tier affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on what a meaningful step up buys at the next tier rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
export const howWeEvaluated = [
  { title: "Price and what it actually includes", description: "We confirmed each price reflects the mower as sold, including any battery and charger required to actually mow with it, and excluded anything priced at or above that." },
