...
export const buyingCriteria = [
  { criterion: "Match deck width before comparing power source", explanation: "A 16-inch electric mower and a 21-inch gas mower are not a fair comparison. Compare mowers at the same or nearly the same deck width so the power-source difference is the only real variable.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since match deck width before comparing power source affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on match deck width before comparing power source rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Active mowing time versus interruptions", explanation: "Gas mowers are limited by tank size and refueling speed, while battery mowers are limited by charge capacity and recharge time. Estimate how long your lawn actually takes to mow and compare that against each mower's realistic uninterrupted range.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers weeks after buying, since active mowing time versus interruptions plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of active mowing time versus interruptions, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers for a while." },
  { criterion: "Cut, bagging, and mulching quality", explanation: "Compare deck design, discharge options (mulch, bag, side discharge), and height adjustment range rather than assuming power source alone determines cut quality at a matched deck width.\n\nBuyers who skip past cut, bagging, and mulching quality tend to be the ones leaving disappointed reviews later, not because the lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers in this roundup actually handles cut, bagging, and mulching quality rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Three-year energy, fuel, and maintenance cost", explanation: "Add oil, air filters, spark plugs, and gasoline for a gas mower against battery replacement and electricity for a cordless mower over a three-year ownership window, not just the purchase price.\n\nThree-year energy, fuel, and maintenance cost is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on three-year energy, fuel, and maintenance cost directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers options genuinely diverge." },
  { criterion: "Scenario-based winner, not a universal answer", explanation: "The better mower depends on lawn size, slope, session length, and how much engine maintenance or charge planning the owner wants to take on. Match the mower to the scenario rather than picking a power source first.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since scenario-based winner, not a universal answer affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on scenario-based winner, not a universal answer rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
