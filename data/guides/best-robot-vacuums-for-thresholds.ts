...
export const products: GuideProduct[] = [
  {
    ...
    specList: [{"label":"Feature 1","value":"Self-emptying base"},{"label":"Feature 2","value":"Vacuum and mop combo"},{"label":"Connectivity","value":"App and voice control"},{"label":"Feature 4","value":"Auto-recharge and resume"}],
    description:
