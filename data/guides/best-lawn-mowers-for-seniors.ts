...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    cons: ["Heavier than the compact push mowers in this guide", "Smaller review count than the top pick, though the rating itself is comparable"],
  },
  {
    ...
    cons: ["Best suited to smaller lawns given the 14-inch deck", "Limited review history compared to established models"],
  },
  {
    ...
    cons: ["Small review count makes long-term reliability harder to judge", "Limited to smaller, flatter lawns"],
  },
  {
