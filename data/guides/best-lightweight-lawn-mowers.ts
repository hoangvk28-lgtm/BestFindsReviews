...
export const products: GuideProduct[] = [
  {
    ...
    cons: ["Manual push power struggles in thick or tall grass", "14-inch width means more passes on a larger lawn"],
  },
  {
    id: "greenworks-40v-16-push", rank: 2, badge: "Best Cordless Pick", name: "Greenworks 40V 16-Inch Push Mower with 4.0Ah Battery and Charger",
    ...
    cons: ["Installed battery adds weight versus a bare-frame spec", "Single included pack limits runtime on larger lawns"],
  },
  {
    id: "blackdecker-besta512cm", rank: 3, badge: "Best Compact Combo", name: "BLACK+DECKER 3-in-1 Corded Lawn Mower, Weed Eater, and Edger (BESTA512CM)",
    ...
    cons: ["12-inch width is too narrow for a full-size lawn", "Cord management limits reach and mowing pattern"],
  },
  {
    id: "lawnmaster-meb1114k", rank: 4, badge: "Best Corded Value", name: "LawnMaster MEB1114K Electric Corded Lawn Mower, 15-Inch, 11 Amp",
    ...
    cons: ["Cord length and routing limit mowing pattern and reach", "Not suited to yards without a nearby outlet"],
  },
  {
    id: "ego-lm2114", rank: 5, badge: "Best Power-to-Weight", name: "EGO POWER+ 21-Inch Cordless Electric Lawn Mower with Battery and Charger (LM2114)",
    ...
    cons: ["Heaviest ready-to-mow weight on this list once the battery is installed", "Highest price of the mowers compared here"],
  },
  {
    id: "litheli-14-brushless", rank: 6, badge: "Best Budget Cordless", name: "Litheli Cordless Lawn Mower 14-Inch, Brushless Motor with 5.0Ah Battery and Charger",
    ...
    cons: ["Only 48 reviews, a small sample versus the other listings here", "3.9 rating is on the lower end of this comparison"],
  },
  {
    id: "litheli-14-smart-charger", rank: 7, badge: "Also Consider", name: "Litheli 14-Inch Cordless Lawn Mower with 5.0Ah Battery and Smart Charger",
    ...
    cons: ["Only 29 reviews, the smallest sample in this comparison", "3.6 rating is the lowest among the cordless mowers here"],
  },
  {
    id: "generic-13-cordless-40v", rank: 8, badge: "Budget Pick", name: "13-Inch Cordless Lawn Mower, 40V Electric Mower for Garden, Patio, and Yard",
    ...
    cons: ["Only 19 reviews and a 3.3 rating, the weakest track record in this comparison", "13-inch width is too narrow for a standard lawn"],
  }
];
export const buyingCriteria = [
  { criterion: "Ready-to-mow weight, not bare weight", explanation: "A published weight often excludes the installed battery, fuel, or a full bag. Add those back in mentally, or check owner reviews and manuals, before assuming a listed number is what you will actually lift.\n\nGetting this wrong is one of the more common reasons a lightweight lawn mowers purchase disappoints once it actually arrives, since ready-to-mow weight, not bare weight affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on ready-to-mow weight, not bare weight rather than assuming every lightweight lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Lift points and center of gravity", explanation: "A light mower with an awkwardly placed battery, engine, or handle hinge can feel harder to tilt or carry than a heavier mower with better-placed lift points. Check where the weight sits, not just how much there is.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lightweight lawn mowers weeks after buying, since lift points and center of gravity plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of lift points and center of gravity, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lightweight lawn mowers for a while." },
  { criterion: "Traction and bounce on light frames", explanation: "Very light decks can skip or bounce over uneven ground, thick patches, or roots instead of cutting cleanly, and self-propelled models need enough weight over the drive wheels to avoid wheel spin on slopes.\n\nBuyers who skip past traction and bounce on light frames tend to be the ones leaving disappointed reviews later, not because the lightweight lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lightweight lawn mowers in this roundup actually handles traction and bounce on light frames rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Push force and turning effort", explanation: "A lighter mower is usually easier to push in a straight line, but turning effort depends more on wheel design and deck width than total weight alone. Test turning radius claims against your yard's tightest corner.\n\nPush force and turning effort is easy to overlook next to flashier specs, but it's frequently the difference between a lightweight lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on push force and turning effort directly from the current listing before ordering, since this is one of the more common places where two similarly priced lightweight lawn mowers options genuinely diverge." },
  { criterion: "Maximum bagged-clipping weight", explanation: "A light mower with a full clipping bag can become surprisingly heavy to empty and carry, especially after cutting wet or overgrown grass. Check bag capacity and how the bag attaches before assuming light-mower convenience extends to bag handling.\n\nGetting this wrong is one of the more common reasons a lightweight lawn mowers purchase disappoints once it actually arrives, since maximum bagged-clipping weight affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on maximum bagged-clipping weight rather than assuming every lightweight lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
export const howWeEvaluated = [
  { title: "Ready-to-mow weight over spec-sheet weight", description: "We treated a bare-frame number as a starting point, not a conclusion, and looked at what battery, cord, or accessory weight each mower type actually adds before use." },
  { title: "Category-appropriate comparison", description: "We compared manual, corded, cordless, and combo mowers within their own practical use case rather than ranking every mower on weight alone regardless of what it can realistically cut." },
  { title: "Review depth as a reliability signal", description: "We weighted mowers with a larger review history more heavily than similarly specced mowers with only a handful of reviews, and we called out thin review samples rather than treating every rating as equally proven." },
  { title: "Real ownership fit", description: "We considered lifting, storage, cord or battery workflow, and bag handling together, since a mower that is light on paper can still be inconvenient to live with day to day." },
];
export interface HowToChooseSection { subheading: string; intro?: string; table?: { headers: string[]; rows: string[][] }; cards?: { label: string; text: string }[]; note?: string; }
export const howToChoose: HowToChooseSection[] = [
  { subheading: "Match the Mower to Your Yard and Lifting Needs", table: { headers: ["Buyer situation", "Recommended direction"], rows: [["Smallest possible ready-to-mow weight, flat small lawn","American Lawn Mower 1204-14 14-Inch Push Reel Mower"],["Cordless power with the lowest added battery weight","Greenworks 40V 16-Inch Push Mower"],["Small patches, edges, or patio strips","BLACK+DECKER BESTA512CM 3-in-1"],["Full-size lawn, willing to accept the heaviest ready-to-mow weight here","EGO POWER+ LM2114 21-Inch Cordless Mower"]] } },
  { subheading: "Understand the Weight Tradeoffs by Category", cards: [ { label: "Manual reel", text: "Lightest true ready-to-mow weight since there is no battery or cord, but limited to flat, regularly mowed, thin-grass lawns." }, { label: "Corded electric", text: "No battery weight at the mower, keeping it close to its bare frame weight, but the cord limits range and adds a separate handling task." }, { label: "Cordless battery", text: "Convenient and light relative to gas mowers, but the installed battery is real added weight that a bare-frame spec can hide." } ] },
  { subheading: "Real Ownership Checklist", table: { headers: ["Factor", "Verify before buying"], rows: [["Ready-to-mow weight", "Confirm weight with battery, bag, or accessory installed, not the bare frame figure"], ["Lift points", "Check where handles and hinge points sit relative to the mower's balance"], ["Bag capacity", "Confirm how heavy a full bag gets on your typical grass length and moisture"], ["Review history", "Weigh a rating against how many reviews back it, especially for newer cordless listings"]] } },
  { subheading: "Daily Handling and Storage Checklist", cards: [ { label: "Before mowing", text: "Check that the ready-to-mow weight, including any installed battery, is something you can comfortably lift over a step or into a trunk." }, { label: "After mowing", text: "Consider how heavy the mower gets with a full bag, and whether the frame is light enough to fold, hang, or carry into storage without strain." } ] },
];
export const faq = [
  { q: "Is a mower's listed weight the same as what I will actually lift?", a: "Not always. Listed weight sometimes excludes the battery, cord, or a full clipping bag. Check the ready-to-mow weight with those items included before assuming the printed number is what you will handle." },
  { q: "Are reel mowers always the lightest option?", a: "Usually yes, since they have no motor, battery, or fuel to add weight. The tradeoff is that they only work well on flat, regularly mowed, thin-grass lawns rather than thick or overgrown grass." },
  { q: "Does a light cordless mower lose cutting power compared to a heavier one?", a: "Not necessarily, but a very light frame can be more prone to bouncing over uneven ground or thick patches, and self-propelled versions need enough weight over the drive wheels to avoid slipping on slopes." },
  { q: "Should I trust a rating from only a handful of reviews the same as one with thousands?", a: "No. A rating backed by a small review count, like the Litheli and generic 13-inch listings in this comparison, is less proven than a rating built on thousands of reviews, even if the star rating looks similar." },
  { q: "What is the real advantage of a lightweight mower?", a: "Easier lifting into storage or a vehicle, less push effort on flat ground, and simpler handling for smaller or less physically demanding yards. It is not automatically a sign of better cutting performance on a larger or tougher lawn." },
];
