...
export const buyingCriteria = [
  { criterion: "Current vs legacy", explanation: "Treat older HRN and HRX gas machines as used or remaining stock, not direct equivalents to the current battery lineup. Verify recall and service status by model and serial number.\n\nGetting this wrong is one of the more common reasons a lawn mowers honda purchase disappoints once it actually arrives, since current vs legacy affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on current vs legacy rather than assuming every lawn mowers honda in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Residential vs commercial", explanation: "HRN and HRX target homeowners while HRC is designed for frequent commercial work. Warranty, weight, price, and duty cycle change with that distinction.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers honda weeks after buying, since residential vs commercial plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of residential vs commercial, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers honda for a while." },
  { criterion: "Battery bay and energy", explanation: "HRN-BV and HRX-BV use one bay; HRX-BE and HRC-BE support two. Battery count and amp-hours matter more than the family name.\n\nBuyers who skip past battery bay and energy tend to be the ones leaving disappointed reviews later, not because the lawn mowers honda was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers honda in this roundup actually handles battery bay and energy rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Published runtime", explanation: "Honda states roughly 30 minutes with 8Ah and 45 minutes with 12Ah under qualifying conditions. Grass height, pace, drive use, and terrain can reduce that result.\n\nPublished runtime is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers honda that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on published runtime directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers honda options genuinely diverge." },
  { criterion: "Charging and dealer support", explanation: "Honda lists long standard-charge times and optional faster charging. Include charger choice, spare battery cost, parts, and dealer access in the purchase decision.\n\nGetting this wrong is one of the more common reasons a lawn mowers honda purchase disappoints once it actually arrives, since charging and dealer support affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on charging and dealer support rather than assuming every lawn mowers honda in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
