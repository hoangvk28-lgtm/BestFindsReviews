...
export const products: GuideProduct[] = [
  {
    ...
    specList: [{"label":"Feature 1","value":"Vacuum and mop combo"},{"label":"Feature 2","value":"Matrix Clean grid navigation"},{"label":"Feature 3","value":"Self-cleaning brushroll"},{"label":"Connectivity","value":"App and voice control"}],
    description:
