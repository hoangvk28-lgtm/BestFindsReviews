...
export const buyingCriteria = [
  { criterion: "The complete, ready-to-mow price", explanation: "Confirm the listed price includes a usable battery and charger, or that a corded model includes the plug needed to run it. A price that excludes the battery is not really an under $100 price.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since the complete, ready-to-mow price affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on the complete, ready-to-mow price rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  ...
  { criterion: "What meaningfully improves at the next tier", explanation: "Moving above $100 typically buys a wider deck, self-propel, or a larger battery pack. Know what you are giving up at this price so the tradeoff is a deliberate choice, not a surprise.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since what meaningfully improves at the next tier affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on what meaningfully improves at the next tier rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
