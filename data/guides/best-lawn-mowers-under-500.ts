...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    description: "On pricing, the Greenworks 40V 16-Inch is the least expensive complete, ready-to-mow option in this comparison, and it is also the most reviewed, with roughly 12,116 ratings averaging 4.2 out of 5. The included 4.0Ah battery and charger mean there is nothing else to add before the first cut.\n\nThe narrower 16-inch deck means more passes on a medium or large lawn compared to the 21-inch electric and gas mowers ranked above and below it, and there is no self-propel assistance. It fits buyers with a small, flat lawn or anyone already using Greenworks 40V tools who wants to share a battery platform.",
...
export const buyingCriteria = [
  { criterion: "Compare the complete, ready-to-mow price", explanation: "A battery mower's listed price should already include a battery and charger, and a gas mower's listed price should include the engine ready to start. Check the listing carefully so the number you compare against $500 reflects a mower you can actually use on day one, not a bare deck.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since compare the complete, ready-to-mow price affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on compare the complete, ready-to-mow price rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Exclude temporary sale-only qualification", explanation: "A mower that only clears $500 during a limited-time markdown is not reliably a sub-$500 mower. Check the current, non-promotional price before counting it toward this budget tier.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers weeks after buying, since exclude temporary sale-only qualification plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of exclude temporary sale-only qualification, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers for a while." },
  { criterion: "Set a minimum bar for cut quality, safety, and warranty", explanation: "Even at a lower price, look for a stated cutting height range, a blade-stop or bail safety switch, and a manufacturer warranty of at least two years before considering a mower a real candidate.\n\nBuyers who skip past set a minimum bar for cut quality, safety, and warranty tend to be the ones leaving disappointed reviews later, not because the lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers in this roundup actually handles set a minimum bar for cut quality, safety, and warranty rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Separate power sources at this price point", explanation: "Under $500, gas mowers tend to offer wider decks and self-propel at a lower upfront price, while electric mowers avoid fuel and engine maintenance but add battery cost and charging time. Decide which tradeoff fits before comparing specific models.\n\nSeparate power sources at this price point is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on separate power sources at this price point directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers options genuinely diverge." },
  { criterion: "Know what meaningfully improves above $500", explanation: "Moving past $500 typically buys a larger battery platform, dual-battery power, or a wider commercial-style deck. If none of those upgrades matter for the lawn size in question, staying under $500 usually is not a compromise.\n\nGetting this wrong is one of the more common reasons a lawn mowers purchase disappoints once it actually arrives, since know what meaningfully improves above $500 affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on know what meaningfully improves above $500 rather than assuming every lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
export const howWeEvaluated = [
  { title: "Complete price under the $500 line", description: "We only included mowers whose current, non-promotional listing price for a ready-to-mow unit stays under that including any battery and charger bundled with the electric models." },
