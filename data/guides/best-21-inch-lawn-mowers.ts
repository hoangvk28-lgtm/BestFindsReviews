...
export const products: GuideProduct[] = [
  {
    ...
    description: "The EGO Power+ LM2114 pairs a 21-inch deck with the 56V battery platform, and it ships with a battery and charger rather than requiring a separate purchase to get running. It holds a 4.5 rating across roughly 2,160 reviews on Amazon, which is a large enough sample to trust for a battery mower in this class.\n\nIt is a push model, not self-propelled, so operator effort scales with lawn size and any slope. Confirm the included battery's watt-hours against your lawn size before buying, since runtime in tall or damp grass will be shorter than the rated figure.",
    bestFor: "standard-size lawns where a full-width battery mower with a strong review history matters",
    pros: ["21-inch deck with battery and charger included", "4.5 rating across roughly 2,160 reviews", "56V platform shared across other EGO tools"],
  ...
  },
  {
    ...
    description: "The Greenworks 80V 21-Inch Self-Propelled Mower combines the 21-inch deck with an 80V 4.0Ah battery and a self-propelled drive, which reduces pushing effort on larger or gently sloped lawns. It carries a 4.5 rating from about 586 reviews.\n\nSelf-propel draws from the same battery as the blade, so runtime will run shorter than a push-only model with the same pack. Compare its total weight and turning behavior around beds and obstacles before deciding it fits a smaller or tightly landscaped yard.",
    bestFor: "medium to larger lawns where self-propel reduces walking effort",
    pros: ["Self-propelled drive with a 4.5 rating from about 586 reviews", "Battery and charger included", "80V pack gives more headroom than a 40V or 56V push mower"],
  ...
  },
  {
    ...
    description: "The Greenworks 60V 21-Inch Push Mower pairs the 21-inch deck with a 60V 5.0Ah battery, landing between the 40V and 80V Greenworks mowers in included energy while staying at a push-drive price point. It holds a 4.4 rating from about 494 reviews.\n\nAs a push-only model it needs more operator effort than the self-propelled 80V version, but the larger 5.0Ah pack gives it more working time per charge than smaller included batteries. Weigh that against whether your lawn's terrain makes self-propel worth the added cost.",
    bestFor: "flat to gently sloped lawns where a larger included battery matters more than self-propel",
    pros: ["Larger 5.0Ah included battery than several push competitors", "4.4 rating from about 494 reviews", "Lower price than the self-propelled 80V model"],
    cons: ["Push drive only, so effort increases on slopes or larger lots", "No self-propel option at this price point within the same line"],
  },
  {
    ...
    description: "The Worx WG752 combines a 21-inch deck with a 40V battery platform and 3-in-1 capability, letting you switch between mulching, bagging, and side discharge without changing mowers. It carries a 4.4 rating from about 332 reviews, and Worx rates it for lawns up to roughly half an acre.\n\nThe 40V platform is lighter-duty than the 60V and 80V options here, so verify the included pack's capacity covers your full lawn before committing to a single charge per session. The flexibility of switching cutting modes is the main draw over single-mode competitors.",
    bestFor: "lawns needing flexible mulch, bag, or discharge switching in one machine",
    pros: ["3-in-1 mulch, bag, and discharge switching", "4.4 rating from about 332 reviews", "Manufacturer-rated for lawns up to about 1/2 acre"],
    cons: ["40V platform has less headroom than the 60V or 80V options in this guide", "Battery capacity should be checked against your actual lawn size, not just the acre rating"],
  },
  {
    ...
    description: "The Greenworks 80V 21-Inch Push Mower uses the same 80V 4.0Ah battery as its self-propelled sibling but skips the drive motor, so all of that energy goes to the blade instead of being shared with propulsion. It has the highest rating of the mowers in this guide at 4.6, though from a smaller sample of about 200 reviews.\n\nWithout self-propel, operator effort still scales with lawn size and slope, but the tradeoff is longer working time per charge than a self-propelled mower pulling from the same pack. It is also the most expensive push model in this comparison.\n\nCompare its price against the self-propelled 80V version if walking effort is a bigger concern than runtime.",
    bestFor: "buyers who want the 80V platform's runtime without paying for self-propel",
    pros: ["4.6 rating, the highest in this guide, from about 200 reviews", "Full 80V 4.0Ah battery energy goes to the blade with no drive motor drawing from it", "Battery and charger included"],
    cons: ["Highest price of the push models compared here", "Review sample is smaller than several other models in this guide"],
  },
  {
    ...
    description: "The SENIX X6 pairs a 21-inch deck with a 60V 8Ah battery, the largest included pack by amp-hours in this guide, along with self-propelled drive, a 7-level cutting height adjustment, and a smart display for monitoring the mower's status.\n\nIts rating and review count are limited (3.8 from about 16 reviews), so treat the feature set as promising but not yet proven at scale the way the higher-review-count models here are. Buyers who want the largest included battery and the most adjustment options should weigh that against the thinner review history.",
    bestFor: "buyers prioritizing a large included battery and adjustable features over an established review history",
...
export const howWeEvaluated = [
  ...
  { title: "Review evidence", description: "We weighed each model's Amazon rating against its review count so a high rating on a very small sample was not treated the same as a high rating backed by hundreds or thousands of reviews." },
];
export interface HowToChooseSection { subheading: string; intro?: string; table?: { headers: string[]; rows: string[][] }; cards?: { label: string; text: string }[]; note?: string; }
export const howToChoose: HowToChooseSection[] = [
  { subheading: "Match the Property Before the Badge", table: { headers: ["Buyer situation", "Recommended direction"], rows: [["Want the most proven, widely reviewed option", "EGO Power+ LM2114 21-Inch Cordless Mower"], ["Larger lawn where self-propel matters most", "Greenworks 80V 21-Inch Self-Propelled Mower"], ["Want a bigger included battery at a lower price", "Greenworks 60V 21-Inch Push Mower"], ["Need to switch between mulch, bag, and discharge often", "Worx WG752 40V 21-Inch 3-in-1 Mower"], ["Want maximum runtime without paying for self-propel", "Greenworks 80V 21-Inch Push Mower"]] } },
...
export const faq = [
  ...
  { q: "Should I trust a mower's rating if it only has a small number of reviews?", a: "A high rating from a small review count, like the SENIX X6's 3.8 rating from about 16 reviews, is less proven than a similar or lower rating backed by hundreds or thousands of reviews. Weigh review count alongside the rating itself." },
