...
export const buyingCriteria = [
  { criterion: "Brushless motor is not automatic proof of quality", explanation: "A brushless claim in a listing title describes motor design, not deck quality, controller durability, or how the mower behaves in thick grass. Treat it as one input, not a final verdict.\n\nGetting this wrong is one of the more common reasons a brushless lawn mowers purchase disappoints once it actually arrives, since brushless motor is not automatic proof of quality affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on brushless motor is not automatic proof of quality rather than assuming every brushless lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Runtime, heat, and bog-recovery under load", explanation: "Manufacturer runtime figures rarely reflect tall, damp, or dense grass. Check whether the motor and controller recover cleanly from a bog-down or need a full stop to cool.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a brushless lawn mowers weeks after buying, since runtime, heat, and bog-recovery under load plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of runtime, heat, and bog-recovery under load, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the brushless lawn mowers for a while." },
  { criterion: "Controller protection", explanation: "Brushless motors rely on an electronic controller. Overcurrent and thermal protection in that controller affects reliability more than the motor label alone.\n\nBuyers who skip past controller protection tend to be the ones leaving disappointed reviews later, not because the brushless lawn mowers was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each brushless lawn mowers in this roundup actually handles controller protection rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Motor warranty and repairability", explanation: "Compare stated warranty length on the motor and controller, and whether replacement parts or repair service are realistically available for the brand.\n\nMotor warranty and repairability is easy to overlook next to flashier specs, but it's frequently the difference between a brushless lawn mowers that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on motor warranty and repairability directly from the current listing before ordering, since this is one of the more common places where two similarly priced brushless lawn mowers options genuinely diverge." },
  { criterion: "Rank the complete mower, not just the motor label", explanation: "Deck width, battery capacity, build quality, and review history all affect whether a mower is a good buy, regardless of what the motor is called.\n\nGetting this wrong is one of the more common reasons a brushless lawn mowers purchase disappoints once it actually arrives, since rank the complete mower, not just the motor label affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on rank the complete mower, not just the motor label rather than assuming every brushless lawn mowers in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
];
