...
export const buyingCriteria = [
  { criterion: "Mower class first", explanation: "Choose a tractor for attachments and familiar steering, a zero-turn for open-lawn maneuvering, or a compact rider when gates and storage are the constraint.\n\nGetting this wrong is one of the more common reasons a lawn mowers riding purchase disappoints once it actually arrives, since mower class first affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on mower class first rather than assuming every lawn mowers riding in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." },
  { criterion: "Deck and total width", explanation: "Measure the narrowest gate, shed door, trailer, and storage aisle. Leave clearance beyond the advertised deck width because chutes and tires can extend farther.\n\nThis is the kind of detail that looks minor in a spec list but shapes how satisfied you actually are with a lawn mowers riding weeks after buying, since deck and total width plays out differently in daily use than it does on paper.\n\nRead the product listing and recent reviews specifically for mentions of deck and total width, since this detail is often understated in the bullet points but shows up clearly once real buyers have used the lawn mowers riding for a while." },
  { criterion: "Terrain and braking", explanation: "Use only slopes allowed by the manufacturer. Traction, stopping, and safe turning matter more than a top-speed claim.\n\nBuyers who skip past terrain and braking tend to be the ones leaving disappointed reviews later, not because the lawn mowers riding was defective, but because this specific detail didn't match what they actually needed.\n\nCompare how each lawn mowers riding in this roundup actually handles terrain and braking rather than assuming they're interchangeable on this point, since the listings here differ on it more than the headline specs suggest." },
  { criterion: "Ride and control reach", explanation: "Check step-over height, seat support, pedal or lap-bar reach, and vibration exposure before buying a machine you will use for an hour at a time.\n\nRide and control reach is easy to overlook next to flashier specs, but it's frequently the difference between a lawn mowers riding that fits your routine and one that quietly becomes a hassle.\n\nConfirm the exact detail on ride and control reach directly from the current listing before ordering, since this is one of the more common places where two similarly priced lawn mowers riding options genuinely diverge." },
  { criterion: "Delivered ownership cost", explanation: "Budget delivery, fuel or batteries, blades, belts, tires, annual service, and transport to a dealer, not only the mower price.\n\nGetting this wrong is one of the more common reasons a lawn mowers riding purchase disappoints once it actually arrives, since delivered ownership cost affects real day-to-day use in a way marketing photos and bullet points don't always make obvious.\n\nBefore buying, check the specific listing's stated details on delivered ownership cost rather than assuming every lawn mowers riding in this comparison handles it the same way, since this is exactly the kind of detail that varies more than buyers expect within the same price range." }
];
