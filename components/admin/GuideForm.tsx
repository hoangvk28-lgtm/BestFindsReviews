...
export function GuideForm({ action, guide, mode, products }: GuideFormProps) {
  ...
  function onAsinChange(i: number, asin: string) {
    updatePick(i, {
      asin,
      affiliateUrl: asin ? `https://www.amazon.com/dp/${asin.trim()}?tag=bestfindsreviews0d-20` : "",
    });
  }
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <AdminFormField label="Author" htmlFor="author" error={fe.author}>
            <input
              ...
              type="text"
              className={inputClass}
              defaultValue={guide?.author ?? "BestFindsReviews Editorial Team"}
            />
          </AdminFormField>
              ...
              <div className="p-4 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <AdminFormField label="ASIN" htmlFor={`pick_asin_${i}`}
                    hint="Auto-fills affiliate URL with bestfindsreviews0d-20 tag">
                  ...
                  <AdminFormField label="Affiliate URL" htmlFor={`pick_affiliateUrl_${i}`}
                    ...
                    <input id={`pick_affiliateUrl_${i}`} type="url" className={inputClass}
                      ...
                      placeholder="https://www.amazon.com/dp/…?tag=bestfindsreviews0d-20" />
                  </AdminFormField>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <AdminFormField label="BestFindsReviews Fit Score (0–10)" htmlFor={`pick_fitScore_${i}`}
