...
const PATHS: Record<string, React.ReactNode> = {
  ...
  "laptop-stands": (
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25M3 9.75h18v7.5A2.25 2.25 0 0 1 18.75 19.5H5.25A2.25 2.25 0 0 1 3 17.25V9.75zm0 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 6v3.75" />
  ),
  "cable-management": (
...
export function CategoryIllustration({
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(135deg, ${categoryColor}18 0%, ${categoryColor}2e 100%)`,
      }}
      aria-hidden="true"
    >
      <svg
