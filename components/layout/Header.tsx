  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-border shadow-sm">
      ...
      <div className="bg-brand text-ink-inverse text-xs py-1.5 px-4 flex items-center justify-center gap-2">
        <span className="opacity-90 hidden sm:inline">BestFindsReviews earns a commission on qualifying Amazon purchases.</span>
      ...
      <Container className="flex items-center justify-between h-16 gap-4">
        ...
        <Link
          ...
          aria-label="BestFindsReviews - Home"
        >
          <Image
            src="/logo-bestfindsreviews-official.png"
            alt="BestFindsReviews"
            width={240}
            height={64}
