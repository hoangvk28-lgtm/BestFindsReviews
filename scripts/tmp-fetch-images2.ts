...
const asins = fs.readFileSync("/tmp/wr_scratch/asin_list2.txt", "utf-8").trim().split("\n");
...
async function main() {
  ...
  fs.writeFileSync("/tmp/wr_scratch/asin_image_map2.json", JSON.stringify(map, null, 2));
