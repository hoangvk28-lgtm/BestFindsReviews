...
export interface GuideProductPick {
  ...
  name: string;
  brand?: string;
  asin?: string;        // auto-generates affiliateUrl: https://www.amazon.com/dp/{ASIN}?tag=worthrated0d-20
  ...
  fitScore?: number;    // 0–10 editorial score — labeled "WorthRated Fit Score" in UI
