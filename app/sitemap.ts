...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/guide/how-to-choose-a-microwave-with-simple-controls`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE_URL}/guide/choosing-kitchen-appliances-with-readable-displays`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE_URL}/guide/robot-vacuum-brand-comparison`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE_URL}/guide/are-robot-vacuums-worth-it`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
