    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning Elite Gourmet ETO449X Toaster Oven up to Oster® Compact Air Fryer Toaster Oven. Convection Countertop Pizza, with a focus on counting actions from cold oven to finished common tasks, and cross-checked Usable interior versus external footprint and Cleaning, accessories and support against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
