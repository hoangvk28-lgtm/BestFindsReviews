    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning Uwant Carpet Cleaner Machine 18Kpa Portable Carpet Cleaner for Cars up to Shark StainStriker Portable Carpet/Upholstery Cleaner, with a focus on measuring stored footprint including hose and tools, and cross-checked tank cleanup and cord/hose storage against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
