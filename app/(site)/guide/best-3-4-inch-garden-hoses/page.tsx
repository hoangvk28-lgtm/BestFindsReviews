    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning PUUKU Garden Hose 25ft x 5/8" up to Rosy Earth 100 FT Garden Hose Expandable - 304 Stainless Steel Water, with a focus on verifying true ID through the hose and fittings, and cross-checked Working pressure and measured flow and repairability and warranty against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
