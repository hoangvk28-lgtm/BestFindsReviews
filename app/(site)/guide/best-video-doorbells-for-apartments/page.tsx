    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning Blink Video Doorbell - Head-to-toe HD view up to aosu 5MP Ultra HD Wireless & Wired Video Doorbell Camera, with a focus on separating peephole, adhesive battery and landlord-approved wired options, and cross-checked Notification, audio and video reliability and Installation and long-term support against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
