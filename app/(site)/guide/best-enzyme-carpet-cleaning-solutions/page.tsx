...
import {
  ...
  howToChoose,
  type GuideProduct,
} from "@/data/guides/best-enzyme-carpet-cleaning-solutions";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-enzyme-carpet-cleaning-solutions",
...
export default async function Page() {
  const guide = await getPublicGuideBySlug("best-enzyme-carpet-cleaning-solutions");
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-enzyme-carpet-cleaning-solutions` },
    about: [{"@type":"Thing","name":"Best Enzyme Carpet Cleaning Solutions (2026)"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Enzyme Carpet Cleaning Solutions (2026)", item: `${SITE_URL}/guide/best-enzyme-carpet-cleaning-solutions` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-enzyme-carpet-cleaning-solutions#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Enzyme Carpet Cleaning Solutions (2026)</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          ...
          <div className="md:hidden h-56 sm:h-64 flex items-center justify-center">
            <Image src={heroImg} alt="Best Enzyme Carpet Cleaning Solutions (2026)" width={900} height={420} className="w-full h-full object-contain" priority unoptimized />
          </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Enzyme is a cleaning-formula property, not a machine category, so this guide covers enzyme-based cleaning solutions rather than carpet-cleaning machines. Best Enzyme Carpet Cleaning Solutions can look similar in a listing photo but differ in ways that matter once real daily use is involved: enzyme disclosure, surface compatibility, and dwell time are the details most listings gloss over in favor of a generic spec sheet. Capacity alone in this lineup spans from 32 on the Rocco & Roxie Supply Co. Rocco & Roxie Enzyme Stain & Odor Eliminator up to 64 on the Nature's Miracle Carpet Shampoo Pet Stain & Odor Remover, a real difference worth checking against your own use case.</p>
          <p>We compared all 8 models below, spanning Resolve Ultra Pet Carpet Cleaner Spray - for Removal of Pet Stains & at $9.46 up to Biokleen Bac Out Enzyme Cleaner at $34.98, with a focus on requiring manufacturer disclosure that the formula uses enzymatic action rather than generic pet-stain marketing, and cross-checked machine compatibility and third-party certification against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>

        {buyingCriteria.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">{buyingCriteria.length} Criteria to Look For Before Buying a Enzyme Carpet Cleaning Solutions (2026)</h2>
        ...
        {howWeEvaluated.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">How We Evaluated These Enzyme Carpet Cleaning Solutions (2026)</h2>
        ...
        {howToChoose.length > 0 && (
          <section className="mb-14">
            <h2 className="text-2xl font-bold text-ink mb-6 tracking-tight">How to Choose the Right Enzyme Carpet Cleaning Solutions (2026)</h2>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=Enzyme+Carpet+Cleaning+Solutions&tag=worthrated-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
