    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning Resolve Ultra Pet Carpet Cleaner Spray - for Removal of Pet Stains & up to Biokleen Bac Out Enzyme Cleaner, with a focus on requiring manufacturer disclosure that the formula uses enzymatic action rather than generic pet-stain marketing, and cross-checked machine compatibility and third-party certification against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
