      ...
      <Container className="py-12 max-w-3xl">
        ...
        <section className="mt-14 p-6 rounded-2xl border border-border bg-white">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <Link prefetch={false} href="/guide/best-easy-to-use-coffee-makers" className="flex items-center justify-between p-4 rounded-xl border border-border hover:border-brand/40 hover:shadow-sm transition-all group">
