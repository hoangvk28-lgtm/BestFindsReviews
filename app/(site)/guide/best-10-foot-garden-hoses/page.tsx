    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>This roundup covers 7 current models and prioritizes measuring dry and filled weight at the exact length over spec-sheet comparisons alone. Prices here run from $10.26 (Camco TastePURE 10-Ft Water Hose - RV Drinking Water Hose Contains No) to $26.09 (ARBUTUS Garden Hose 5/8"x 25ft Brass Rubber Heavy Duty Water Hose 600 PSI). Working pressure and measured flow and Repairability and warranty were checked against the live listing data for each pick, not assumed from the box copy.</p>
        </section>
