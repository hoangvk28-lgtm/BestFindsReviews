    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>Below, all 8 models are broken down side by side, spanning PeoMev Metal Garden Hose Holder Wall Mounted Water Hose Holder for Outside up to Giraffe Tools Retractable Garden Hose Reel 1/2"130FT Wall Mount Auto, with particular attention to publishing substrate and anchor requirements for wood, masonry and posts. We also verified Swivel restriction and replacement hardware directly against current listings instead of taking manufacturer copy at face value.</p>
        </section>
