    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 8 models below, spanning BISSELL TurboClean Upright Carpet Cleaner up to Rug Doctor Pro Deep Commercial Carpet Cleaner with Oxy Cleaner Bundle, with a focus on separating products available to buy from rental-only or location-dependent machines, and cross-checked tool package and solution requirements against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
