...
import {
  ...
  howToChoose,
  type GuideProduct,
} from "@/data/guides/best-90-to-100-inch-tvs";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-90-to-100-inch-tvs",
...
export default async function Page() {
  const guide = await getPublicGuideBySlug("best-90-to-100-inch-tvs");
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-90-to-100-inch-tvs` },
    about: [{"@type":"Thing","name":"Best 90-to-100-Inch TVs (2026)"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best 90-to-100-Inch TVs (2026)", item: `${SITE_URL}/guide/best-90-to-100-inch-tvs` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-90-to-100-inch-tvs#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best 90-to-100-Inch TVs (2026)</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          ...
          <div className="md:hidden h-56 sm:h-64 flex items-center justify-center">
            <Image src={heroImg} alt="Best 90-to-100-Inch TVs (2026)" width={900} height={420} className="w-full h-full object-contain" priority unoptimized />
          </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Current premium extra-large inventory clusters around 97, 98, 100 inches and larger rather than an exact 90 or 95 inches, so this guide covers the 90-to-100-inch class as one band instead of forcing a thin exact-size product pool. Best 90-to-100-Inch TVs can look similar in a listing photo but differ in ways that matter once real daily use is involved: Current US product count, Exact diagonal versus class size, and Neighboring-size substitution are the details most listings gloss over in favor of a generic spec sheet. Screen Size alone in this lineup spans from 85" on the Samsung 85-Inch Class U8000H Series Crystal UHD up to 100" on the Hisense 100" Class E6 Series QLED 4K UHD Smart Fire TV (100E6QF, a real difference worth checking against your own use case.</p>
          <p>We compared all 10 models below, spanning INSIGNIA 85" Class F50 Series LED 4K UHD Smart Fire TV with Alexa at $599.99 up to Sony BRAVIA 5 98 Inch TV at $4998.00, with a focus on requiring at least five current US products across this size band before publishing, and cross-checked Distinct buyer intent and Duplicate model pool against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>

        {buyingCriteria.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">{buyingCriteria.length} Criteria to Look For Before Buying a 90-to-100-Inch TVs (2026)</h2>
        ...
        {howWeEvaluated.length > 0 && (
          <section className="mb-12 p-6 rounded-2xl border border-border bg-white">
            <h2 className="text-xl font-bold text-ink mb-1 tracking-tight">How We Evaluated These 90-to-100-Inch TVs (2026)</h2>
        ...
        {howToChoose.length > 0 && (
          <section className="mb-14">
            <h2 className="text-2xl font-bold text-ink mb-6 tracking-tight">How to Choose the Right 90-to-100-Inch TVs (2026)</h2>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=90-to-100-Inch+TVs&tag=worthrated-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
