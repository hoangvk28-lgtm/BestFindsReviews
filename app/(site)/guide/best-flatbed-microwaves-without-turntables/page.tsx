    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          ...
          <p>We compared all 5 models below, spanning TOSHIBA Countertop Microwave Oven up to Panasonic Japanese Microwave, with a focus on separating true flatbed consumer microwaves from commercial units using different internal wave-distribution systems, and cross-checked cleaning and technology type against the current listing data rather than repeating manufacturer marketing claims.</p>
        </section>
