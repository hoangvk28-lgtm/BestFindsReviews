    ...
    <Container narrow className="py-14">
      ...
      <header className="mb-10">
        ...
        <p className="text-lg text-ink-secondary leading-relaxed max-w-2xl">
          Every recommendation on BestFindsReviews follows the same documented process. Here is exactly how we evaluate products, how we assign scores, and what our editorial badges mean.
        </p>
      </header>
