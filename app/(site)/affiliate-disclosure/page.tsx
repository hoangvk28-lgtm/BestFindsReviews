    ...
    <Container narrow className="py-14">
      ...
      <div className="space-y-10 text-sm text-ink-secondary leading-relaxed">
        ...
        <section>
          ...
          <p>
            Our links include an affiliate tag (<code className="font-mono text-xs bg-bg px-1.5 py-0.5 rounded border border-border text-ink">worthrated0d-20</code>) that allows Amazon to attribute the referral to our account. This tag is the only information passed; we do not receive your name, address, or payment details.
          </p>
        </section>
